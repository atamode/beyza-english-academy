...
export function renderWeeklyParentReport(delivery){
  ...
  const text=["Haftalık gelişim raporu",week,"Çocuğunuzun doğrulanmış öğrenme etkinliklerinden hazırlanan özet aşağıdadır.",childText,"Veli paneli: https://pomante.com.tr/#/parent/reports","E-posta tercihleri: https://pomante.com.tr/#/parent/reports"].join("\n\n");
