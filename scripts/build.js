...
const essentialMediaMetadata=new Set(["assets/games/poma-football-v1/asset-manifest.json","assets/games/poma-volleyball-v1/asset-manifest.json"]);
const precache=["./",...base.filter(f=>essentialMediaMetadata.has(f)||!heavyMediaPrefixes.some(prefix=>f.startsWith(prefix)))];
