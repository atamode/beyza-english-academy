...
export function pricingErrorView() { return `<div class="card pricing-error" role="alert"><h3>Planlar şu anda yüklenemedi</h3><p>Fiyat göstermiyoruz; bağlantınızı kontrol edip yeniden deneyebilirsiniz.</p><button type="button" class="button secondary" data-action="retry-pricing">Tekrar dene</button></div>`; }
