...
| MT-003 | Verify analytics implementation and funnel baseline | Blocked | P0 | Implementation audited/repaired; MT-009 required |
| MT-004 | Validate first keyword/audience opportunity set | Done | P1 | R-003 / Decision D-006 / [Keyword Map](KEYWORD_MAP.md) |
| MT-005 | Approve first Knowledge Center cluster and briefs | Ready | P1 | [Content Clusters](CONTENT_CLUSTERS.md) |
...
| MT-010 | Produce game-hub and sport product-page briefs | Ready | P1 | LP-002, PP-001, PP-002; implementation remains MT-006 |
