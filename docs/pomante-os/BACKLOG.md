...
> **Purpose:** Prioritized candidate work not yet active.
> **Update trigger:** A candidate is added, promoted, rejected, or materially rescoped.
> **Related files:** [Master Tasks](MASTER_TASKS.md), [Idea Bank](IDEA_BANK.md), [Rejected Ideas](REJECTED_IDEAS.md)
...
Promotion requires an outcome, owner, priority, dependencies, and verification method in [Master Tasks](MASTER_TASKS.md).
